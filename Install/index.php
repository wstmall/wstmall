...
<div style="width:960px;margin:0 auto;">
    ...
    <div id="system_agreement" class="main">
        <div class='content'>
			...
			<p style='margin-top:10px;text-indent: 2em'>1. 使用本软件必须保留WSTMall软件页面页脚处的版权标识（Powered by WSTMall）和广州商淘信息科技有限公司下属网站（<a href='http://www.wstmall.net' target='_blank'>http://www.wstmall.net</a>） 的链接，您可以在遵守本协议的基础上，获得WSTMall授权应用于商业用途。</p>
			<p style='text-indent: 2em'>2. 无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用本软件的整体或任何部分，未经本公司书面授权许可，软件首页顶部及页脚处的版权标识（Powered by WSTMall）和广州商淘信息科技有限公司下属网站（<a href='http://www.wstmall.net' target='_blank'>www.wstmall.net</a>） 的链接都必须保留，不能清除或修改。</p>
