...
('38', '3', '结算金额设置', 'settlementStartMoney', 'text', null, null, '0', '（结算金额少于该金额将不能进行结算）', '7'),
...
('43', '3', '评价获取积分数', 'appraisesScore', 'text', '', '', '5', '', '5'),
('44', '3', '自动收货期限', 'autoReceiveDays', 'text', '', '', '10', '天', '8'),
('45', '3', '自动评价期限', 'autoAppraiseDays', 'text', '', '', '7', '天', '9'),
('46', '3', '订单佣金比例', 'poundageRate', 'text', '', '', '1', '%', '6');
